      ...
      {data && data.available && (
        <div className="space-y-6">
          ...
          <div className="card">
            ...
            <CustomerTable rows={data.customers.slice(0, 20)} cur={cur} />
          </div>
          ...
          <div className="card">
            ...
            <CustomerTable rows={filteredCustomers.slice(0, 100)} cur={cur} showRank={false} />
...
function CustomerTable({ rows, cur, showRank = true }: { rows: CustRow[]; cur: string; showRank?: boolean }) {
