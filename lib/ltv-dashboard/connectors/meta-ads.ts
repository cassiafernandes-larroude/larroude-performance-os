 ...
 *
 * CURRENCY HANDLING (validated 2026-05-07 in CAC dashboard):
...
export const META_ACCOUNTS: Record<Market, MetaAccount[]> = {
  US: [
    // 2 contas ATIVAS (Set/2025 em diante):
    ...
    // Conta LEGADA (Jan-Ago/2025) — sem campanhas ativas, mantida para histórico.
    { id: 'act_312869193575906', name: 'Larroude US (legacy)', preOrder: false, currency: 'USD' },
  ],
  BR: [
